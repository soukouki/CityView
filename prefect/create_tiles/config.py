...
# ワーカー数の設定
CAPTURE_WORKER_THREADS = int(os.environ.get('CAPTURE_WORKER_THREADS', '4'))
...
CONCURRENCY_CAPTURE = math.ceil(SERVICE_CAPTURE_REPLICAS * CAPTURE_WORKER_THREADS) # なんか1.2倍した分で失敗してるくさいので修正
...
CONCURRENCY_ALL = int(os.environ.get('CONCURRENCY_ALL', str(CONCURRENCY_CAPTURE + CONCURRENCY_ESTIMATE + CONCURRENCY_TILE_CUT + CONCURRENCY_TILE_MERGE + CONCURRENCY_TILE_COMPRESS + CONCURRENCY_CREATE_PANEL)))
