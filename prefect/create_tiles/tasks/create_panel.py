...
def create_panel(params: CreateTilesParams, z: int, resolution: dict, tile_results: list):
    ...
    try:
        ...
        panel_id = register_panel(params, resolution, output_path, session=session)
        return {
            "path": output_path,
            "panel_id": panel_id,
        }
...
def register_panel(params: CreateTilesParams, resolution: dict, panel_path: str, session: requests.Session):
