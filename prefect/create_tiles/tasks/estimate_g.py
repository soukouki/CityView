...
from create_tiles.utils import game_tile_to_screen_lefttop_coord, parse_xy_str, log, get_session, close_session
...
def estimate(params: CreateTilesParams, image_path: str, adjacent_images: list, hint_x: int, hint_y: int, session: requests.Session):
...
def register_estimated_coords(screenshot_id: str, estimated_x: int, estimated_y: int, session: requests.Session):
